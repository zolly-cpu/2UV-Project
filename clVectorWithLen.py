    ...
    def calculate_all(self,x_dimension,y_dimension,z_dimension):
        ...
        while j < y_dimension:
            ...
            while i < x_dimension:
               Tracker_Length_3 = []
               while z < z_dimension:
                    self.Tracker_CoordY.append([j,i,z])
                    v = math.sqrt((i*i)+(j*j))
                    p = math.sqrt((v*v)+(z*z))
                    Tracker_Length_3.append(p)
                    print (p)
        ...
        while j < y_dimension:
           ...
           while i < x_dimension:
               Tracker_Length_3 = []
               while z < z_dimension:
                    self.Tracker_CoordZ.append([j,i,z])
                    v = math.sqrt((i*i)+(j*j))
                    p = math.sqrt((v*v)+(z*z))
                    Tracker_Length_3.append(p)
                    z = z + 1
        ...
        while i < len(BlockListNumberX):
            while j < len(BlockListNumberY):
                while k < len(BlockListNumberZ):
                    ...
                    if (elements_coord_1[0] > ((elements_coord_3[1]) - blockTolerance) and 
                        elements_coord_1[0] < ((elements_coord_3[1]) + blockTolerance) and
                        elements_coord_1[0] > ((dim2 - elements_coord_2[1]) - blockTolerance) and 
                        elements_coord_1[0] < ((dim2 - elements_coord_2[1]) + blockTolerance) and
                        elements_coord_1[1] > ((elements_coord_2[0]) - blockTolerance) and
                        elements_coord_1[1] < ((elements_coord_2[0]) + blockTolerance) and
                        elements_coord_1[1] > ((dim3 - elements_coord_3[0]) - blockTolerance) and
                        elements_coord_1[1] < ((dim3 - elements_coord_3[0]) + blockTolerance)):
                            print ('---------------')
...
def main():
    ...
    meInterfaceScript.calculate_all(20,20,20)
    #To implement tolerances
    bestFitValue = meInterfaceScript.bestfit(15,15,15,20,20,20)
