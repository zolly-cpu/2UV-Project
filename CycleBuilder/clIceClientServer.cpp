...
/*
bool clIceClientServer::getServerFileStructure(std::string& paFileStructure)
{
	try
    {
			
		meServerAppServer->getServerFileStructure(paFileStructure);
        return true;
    }
    catch(exception &e)
    {
...
bool clIceClientServer::getServerAppStructure(std::string& paAppStructure)
{
	try
    {
			
		meServerAppServer->getServerAppStructure(paAppStructure);
        return true;
    }
    catch(exception &e)
    {
